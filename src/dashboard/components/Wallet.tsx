...
<div className="lg:flex lg:items-center lg:justify-between  p-2 ">
      ...
      <span className="hidden sm:block">
          ...
          >
             <Link to="/app" type="button">dApp</Link>
          </button>
        </span>
        <span className="hidden sm:block">
          <button
        ...
        <span className="hidden sm:block">
          <button
            ...
            className="inline-flex items-center px-4 py-2 duration-200 hover:text-black rounded-md shadow-sm hover:shadow-md text-sm font-medium text-gray-700 bg-white " onClick={ ()=>window.open("https://github.com/vamise/spl-token-generator")}
          >
             Code
          </button>
        </span>
